...
public final class ClaudeSDKClient implements AutoCloseable {
    ...
    /**
     * Get the internal Query object for access to control methods
     * (e.g. setModel, mcpServerStatus, supportedCommands, etc.).
     *
     * @return a Query wrapping the internal StreamingQuery
     */
